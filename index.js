...
//including data in user.js
var users_data = require('/users');
...
router.post('/hotels/:id/:name/booking-confirmation', function (req, res) {
  ...
  res.render('booking-confirmation', { thisHotel: thisHotel, thisRoom: thisRoom, date: req.body } );
});
